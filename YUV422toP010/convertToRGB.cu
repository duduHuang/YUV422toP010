...
__global__ static void convertToRGBKernel(const uint16_t *pV210, uint8_t *tt1,
    ...
    if (tid < (nDstWidth / 8) && tidd < (nDstHeight * 4 / 3)) {
        ...
        k = tid * 18;
        int r = 1596 * v0 - 891648, g = 813 * v0 + 392 * u0 - 542464, b = 2017 * u0 - 1107200;
        tt[0] = (y0 + r) *0.249 / 1000;
        tt[1] = (y0 - g) *0.249 / 1000;
        tt[2] = (y0 + b) *0.249 / 1000;

        tt[3] = (y1 + r) *0.249 / 1000;
        tt[4] = (y1 - g) *0.249 / 1000;
        tt[5] = (y1 + b) *0.249 / 1000;

        tt1[j * nDstWidth * 9 / 4 + k + 0] = tt[0];
        //tt1[j * nDstWidth * 9 / 4 + k + 1] = tt[0] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 1] = tt[1];
        //tt1[j * nDstWidth * 9 / 4 + k + 3] = tt[1] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 2] = tt[2];
        //tt1[j * nDstWidth * 9 / 4 + k + 5] = tt[2] >> 8;

        tt1[j * nDstWidth * 9 / 4 + k + 3] = tt[3];
        //tt1[j * nDstWidth * 9 / 4 + k + 7] = tt[3] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 4] = tt[4];
        //tt1[j * nDstWidth * 9 / 4 + k + 9] = tt[4] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 5] = tt[5];
        //tt1[j * nDstWidth * 9 / 4 + k + 11] = tt[5] >> 8;

        r = 1596 * v1 - 891648, g = 813 * v1 + 392 * u1 - 542464, b = 2017 * u1 - 1107200;
        tt[0] = (y2 + r) *0.249  / 1000;
        tt[1] = (y2 - g) *0.249  / 1000;
        tt[2] = (y2 + b) *0.249  / 1000;

        tt[3] = (y3 + r) *0.249  / 1000;
        tt[4] = (y3 - g) *0.249  / 1000;
        tt[5] = (y3 + b) *0.249  / 1000;

        tt1[j * nDstWidth * 9 / 4 + k + 6] = tt[0];
        //tt1[j * nDstWidth * 9 / 4 + k + 13] = tt[0] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 7] = tt[1];
        //tt1[j * nDstWidth * 9 / 4 + k + 15] = tt[1] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 8] = tt[2];
        //tt1[j * nDstWidth * 9 / 4 + k + 17] = tt[2] >> 8;

        tt1[j * nDstWidth * 9 / 4 + k + 9] = tt[3];
        //tt1[j * nDstWidth * 9 / 4 + k + 19] = tt[3] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 10] = tt[4];
        //tt1[j * nDstWidth * 9 / 4 + k + 21] = tt[4] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 11] = tt[5];
        //tt1[j * nDstWidth * 9 / 4 + k + 23] = tt[5] >> 8;

        r = 1596 * v2 - 891648, g = 813 * v2 + 392 * u2 - 542464, b = 2017 * u2 - 1107200;
        tt[0] = (y4 + r) *0.249  / 1000;
        tt[1] = (y4 - g) *0.249  / 1000;
        tt[2] = (y4 + b) *0.249  / 1000;

        tt[3] = (y5 + r) *0.249  / 1000;
        tt[4] = (y5 - g) *0.249  / 1000;
        tt[5] = (y5 + b) *0.249  / 1000;

        tt1[j * nDstWidth * 9 / 4 + k + 12] = tt[0];
        //tt1[j * nDstWidth * 9 / 4 + k + 25] = tt[0] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 13] = tt[1];
        //tt1[j * nDstWidth * 9 / 4 + k + 27] = tt[1] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 14] = tt[2];
        //tt1[j * nDstWidth * 9 / 4 + k + 29] = tt[2] >> 8;

        tt1[j * nDstWidth * 9 / 4 + k + 15] = tt[3];
        //tt1[j * nDstWidth * 9 / 4 + k + 31] = tt[3] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 16] = tt[4];
        //tt1[j * nDstWidth * 9 / 4 + k + 33] = tt[4] >> 8;
        tt1[j * nDstWidth * 9 / 4 + k + 17] = tt[5];
        //tt1[j * nDstWidth * 9 / 4 + k + 35] = tt[5] >> 8;
    }
    //}
}
